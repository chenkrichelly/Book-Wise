...
const SavedBooks = () => {
    const { isLoggedIn } = useContext(SearchResultContext);
                ...
                <>
                    <header>
                        ...
                        <div className='header-content2'>
                            <h2 className='header-title'>Welcome to Your List!</h2><br /><br />
                            <p className='header-text'>Here, you can curate your reading selections and revisit them anytime. From classics to newly discovered gems, your list is your personal literary sanctuary. Add, remove, and view your books as you wish.</p>
                        </div>
                    </header>
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-content">
                                            ...
                                            <div className="card-footer">
                                                ...
                                                <button type="submit" className='search-button' onClick={() => handleRemoveFromList(book.book_id)}>
